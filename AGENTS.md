...
Bir işe başlarken hangisinin içinde çalışıyorsan **o dizinin `AGENTS.md`'sini** oku;
...
| **`veritabani/docs/INFO.md`** | Şema/pipeline tarafı: tarihli "Güncel çalışma noktası" snapshot'ı, uygulanmış migration'lar ve "Sıradaki işler" yol haritası. |
